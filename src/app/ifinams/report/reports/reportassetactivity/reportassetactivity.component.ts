...
@Component({
  selector: 'app-reportassetactivity',
  templateUrl: './reportassetactivity.component.html'
})
export class Reportassetactivity extends BaseComponent implements OnInit {
  // get param from url
