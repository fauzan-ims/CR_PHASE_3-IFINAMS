...
@Component({
  selector: 'app-reportmaintenanceasset',
  templateUrl: './reportmaintenanceasset.component.html'
})
export class ReportMaintenanceAsset extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileMaintenanceAsset';
