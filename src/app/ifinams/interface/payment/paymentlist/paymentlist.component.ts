...
export class PaymentlistComponent extends BaseComponent implements OnInit {
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listpayment = parse.data;
          if (parse.data != null) {
            this.listpayment.numberIndex = dtParameters.start;
          }
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/interface/paymentlist/paymentdetail', codeEdit]);
  }
  ...
  btnLookupBranch() {
    ...
    $('#datatableLookupBranch').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.GetrowsBase(dtParameters, this.APIControllerBranch, this.APIRouteLookup).subscribe(resp => {
          const parse = JSON.parse(resp);
