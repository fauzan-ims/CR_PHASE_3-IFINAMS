...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './salehistorylist.component.html'
})

export class SaleHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    public listsale: any = [];
    public dataTamp: any = [];
    public status: any;
    ...
    //controller
    private APIController: String = 'SaleHistory';
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subsalehistorylist/salehistorydetail', codeEdit]);
    }
