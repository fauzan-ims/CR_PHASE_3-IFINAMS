...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './pricingrequestlist.component.html'
})

export class PricingrequestlistComponent extends BaseComponent implements OnInit {
  // variable
  public listpricingrequest: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listpricingrequest = parse.data;

          if (parse.data != null) {
            this.listpricingrequest.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/sellanddisposal/subpricingrequestlist/pricingrequestdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/sellanddisposal/subpricingrequestlist/pricingrequestdetail', codeEdit]);
  }
