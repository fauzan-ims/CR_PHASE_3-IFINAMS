...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './adjustmenthistorylist.component.html'
})

export class AdjustmentHistoryListComponent extends BaseComponent implements OnInit {
    // variable
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.adjustmentlist = parse.data;

                    if (parse.data != null) {
                        this.adjustmentlist.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/inquiry/subadjustmenthistorylist/adjustmenthistorydetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subadjustmenthistorylist/adjustmenthistorydetail', codeEdit]);
    }
