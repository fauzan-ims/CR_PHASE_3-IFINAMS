...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetincomeledgerlist.component.html'
})

export class AssetIncomeLedgerlistWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'AssetIncomeLedger';
