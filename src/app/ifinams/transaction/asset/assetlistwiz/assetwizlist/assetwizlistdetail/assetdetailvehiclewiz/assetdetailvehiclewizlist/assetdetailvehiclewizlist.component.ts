...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetailvehiclewizlist.component.html'
})

export class AssetDetailVehiclewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailvehicledetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
        ...
        this.dalservice.Getrow(this.dataTamp, this.APIControllerHeader, this.APIRouteForGetRow)
            .subscribe(
                res => {
                    ...
                    if(parsedata.status !== 'HOLD' && parsedata.is_lock === '1')
                    {                        
