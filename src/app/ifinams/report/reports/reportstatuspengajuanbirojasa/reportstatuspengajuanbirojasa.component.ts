...
@Component({
  selector: 'app-reportstatuspengajuanbirojasa',
  templateUrl: './reportstatuspengajuanbirojasa.component.html'
})
export class Reportstatuspengajuanbirojasa extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForLookupAsset: String = 'GetRowsForLookupAssetBiroJasa';
  ...
  // //#region onFormSubmit
  // onFormSubmit(reportForm: NgForm, isValid: boolean) {
  //   if (!isValid) {
  //     swal({
  ...
  //   //dibawah ini untuk convert date 
  ...
  //   //pakai ExcelRecord jika ingin Header dan Datanya saja
  //   this.reportData.p_asset_code = this.model.asset_code;
  //   // this.reportData.p_from_date = this.model.from_date;
  //   // this.reportData.p_to_date   = this.model.to_date;
  //   const dataParam = {
