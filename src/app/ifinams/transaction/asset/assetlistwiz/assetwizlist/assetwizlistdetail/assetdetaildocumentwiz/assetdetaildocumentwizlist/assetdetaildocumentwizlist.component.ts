...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetaildocumentwizlist.component.html'
})

export class AssetDetailDocumentWizlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'AssetDocument';
