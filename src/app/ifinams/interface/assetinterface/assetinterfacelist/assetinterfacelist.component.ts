...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfacelist.component.html'
})

export class AssetInterfacelistComponent extends BaseComponent implements OnInit {
    // variable
    ...
    private APIController: String = 'EfamInterfaceAsset';
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail', codeEdit]);
    }
