...
export class RealizationlistComponent extends BaseComponent implements OnInit {
    ...
    public tampRegisterStatus: String;
    ...
    // API Function
    private APIRouteForGetRows: String = 'GetRowsForRealization';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                dtParameters.paramTamp.push({
                    ...
                    'p_register_status': this.tampRegisterStatus,
    ...
    //#region ddl master module
    PageRegisterStatus(event: any) {
        this.tampRegisterStatus = event.target.value;
        $('#datatable').DataTable().ajax.reload();
    }
    //#endregion ddl master module
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/birojasa/realizationlist/realizationdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/birojasa/realizationlist/realizationdetail', codeEdit]);
    }
