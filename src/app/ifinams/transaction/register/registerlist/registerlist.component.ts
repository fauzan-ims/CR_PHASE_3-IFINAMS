...
export class RegisterlistComponent extends BaseComponent implements OnInit {
    ...
    private APIRouteForGetRows: String = 'GetRowsForMain';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listregister = parse.data;
                    if (parse.data != null) {
                        this.listregister.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subregisterbirojasalist/registerdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subregisterbirojasalist/registerdetail', codeEdit]);
    }
