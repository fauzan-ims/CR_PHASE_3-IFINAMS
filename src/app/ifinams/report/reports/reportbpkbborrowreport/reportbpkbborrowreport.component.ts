...
@Component({
  selector: 'app-reportbpkbborrowreport',
  templateUrl: './reportbpkbborrowreport.component.html'
})
export class Reportbpkbborrowreport extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region onFormSubmit
  onFormSubmit(rptForm: NgForm, isValid: boolean, type: any, print_option: any) {
    if (!isValid) {
      swal({
  ...
  //#region onFormSubmit
  // onFormSubmit(reportForm: NgForm, isValid: boolean, type: any) {
  //   if (!isValid) {
  //     swal({
  //       allowOutsideClick: false,
  //       title: 'Warning',
  ...
  //   this.reportData.p_print_option = 'Excel'
