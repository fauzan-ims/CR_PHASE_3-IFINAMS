...
export class DisposedListComponent extends BaseComponent implements OnInit {
    ...
    private RoleAccessCode = 'R00024650000001A';
    ...
    private APIRouteForGetRows: String = 'GetRowsDisposed';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listdisposed = parse.data;
                    if (parse.data != null) {
                        this.listdisposed.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    selectAllTable() {
      for (let i = 0; i < this.listdisposed.length; i++) {
        this.listdisposed[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.listdisposed.every(function (item: any) {
