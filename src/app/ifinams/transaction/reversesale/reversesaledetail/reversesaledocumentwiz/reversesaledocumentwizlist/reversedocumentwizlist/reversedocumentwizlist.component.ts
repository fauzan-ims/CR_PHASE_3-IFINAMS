...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedocumentwizlist.component.html'
})

export class ReverseDocumentWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'ReverseSaleDocument';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subreversesale/reversesaledetail/reversesaledetail' + parse.id + '/reversesaledocumentlist/' + parse.id + '/reversedocumentlist', parse.id]);
