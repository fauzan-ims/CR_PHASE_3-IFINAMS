...
export class DeliverylistComponent extends BaseComponent implements OnInit {
    ...
    loadData() {
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIControllerDelivery, this.APIRouteForGetRows).subscribe(resp => {
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/birojasa/subdeliverylist/deliverydetail', codeEdit]);
    }
