...
@Component({
  selector: 'app-reportperubahankategori',
  templateUrl: './reportperubahankategori.component.html'
})
export class Reportperubahankategori extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileReportPerubahanCategoryAsset';
