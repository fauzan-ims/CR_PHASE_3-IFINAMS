...
import { ReverseDisposalDetail } from './reversedisposaldetailhistory.routing';
...
@NgModule({
    ...
    declarations: [
        ReverseDisposalDetailHistorywizlistComponent,
    ],
    providers: [
        DALService
    ]
...
export class ReverseDisposalDetailHistoryModule { }
