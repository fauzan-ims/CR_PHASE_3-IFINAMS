...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposalhistorylist.component.html'
})

export class DisposalHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    //controller
    private APIController: String = 'DisposalHistory';
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subdisposalhistorylist/disposalhistorydetail', codeEdit]);
    }
