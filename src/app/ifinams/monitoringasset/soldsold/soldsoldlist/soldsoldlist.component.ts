...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './soldsoldlist.component.html'
})

export class SoldSoldListComponent extends BaseComponent implements OnInit {
    // variable

    public listsoldsold: any = [];
    ...
    private RoleAccessCode = 'R00024630000001A';
    ...
    private APIRouteForGetRows: String = 'GetRowsSold';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listsoldsold = parse.data;
                    if (parse.data != null) {
                        this.listsoldsold.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    selectAllTable() {
      for (let i = 0; i < this.listsoldsold.length; i++) {
        this.listsoldsold[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.listsoldsold.every(function (item: any) {
