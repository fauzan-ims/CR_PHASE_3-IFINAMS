...
@Component({
  selector: 'app-reportreplacementcarcontrol',
  templateUrl: './reportreplacementcarcontrol.component.html'
})
export class ReportreplacementcarcontrolComponent extends BaseComponent implements OnInit {
  // get param from url
