...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposaldocumentwiz.component.html'
})

export class DisposalDocumentReverseWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'DisposalDocument';
