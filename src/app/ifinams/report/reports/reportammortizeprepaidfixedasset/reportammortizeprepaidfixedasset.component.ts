...
@Component({
  selector: 'app-reportammortizeprepaidfixedasset',
  templateUrl: './reportammortizeprepaidfixedasset.component.html'
})
export class ReportammortizeprepaidfixedassetComponent extends BaseComponent implements OnInit {
  // get param from url
