...
@Component({
  selector: 'app-reportassetexchange',
  templateUrl: './reportassetexchange.component.html'
})
export class ReportExchangeAsset extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileExchangeAsset';
