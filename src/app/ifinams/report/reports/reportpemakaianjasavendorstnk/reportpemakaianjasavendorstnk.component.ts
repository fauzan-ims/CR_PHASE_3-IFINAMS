...
@Component({
    selector: 'app-reportpemakaianjasavendorstnk',
    templateUrl: './reportpemakaianjasavendorstnk.component.html'
})
export class ReportpemakaianjasavendorstnkComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    ngOnInit() {
        ...
        this.model.type = 'STNK';
        this.callGetrow();
        // this.model.month = 'Januari'
    }
    ...
    //#region onFormSubmit
    onFormSubmit(rptForm: NgForm, isValid: boolean, print_option: any, type: string) {
        if (!isValid) {
            swal({
        ...
        this.reportData.p_type = this.model.type;
        this.reportData.p_is_condition = '1';


        const dataParam = {
            TableName: 'rpt_pemakaian_jasa_vendor_stnk',
            SpName: 'xsp_rpt_pemakaian_jasa_vendor_stnk',
    ...
    changeMonth(event: any) {
        this.model.month = event.target.value
    }
