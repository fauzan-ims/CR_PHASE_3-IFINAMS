...
@Component({
  selector: 'app-reportpenjualanpemutihan',
  templateUrl: './reportpenjualanpemutihan.component.html'
})
export class Reportpenjualanpemutihan extends BaseComponent implements OnInit {
  // get param from url
