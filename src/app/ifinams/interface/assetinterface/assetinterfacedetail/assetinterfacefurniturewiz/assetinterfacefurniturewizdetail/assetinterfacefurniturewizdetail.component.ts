...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfacefurniturewizdetail.component.html'
})

export class AssetInterfaceFurniturewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIController: String = 'EfamInterfaceAssetFurniture';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['assetinterfacemachinedetail' + this.param + '/assetinterfacefurnituredetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
