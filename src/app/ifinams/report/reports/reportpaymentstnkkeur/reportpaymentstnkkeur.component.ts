...
@Component({
  selector: 'app-reportpaymentstnkkeur',
  templateUrl: './reportpaymentstnkkeur.component.html'
})
export class Reportpaymentstnkkeur extends BaseComponent implements OnInit {
  // get param from url
