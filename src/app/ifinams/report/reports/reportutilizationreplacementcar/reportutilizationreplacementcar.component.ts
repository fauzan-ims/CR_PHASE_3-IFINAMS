...
@Component({
  selector: 'app-reportutilizationreplacementcar',
  templateUrl: './reportutilizationreplacementcar.component.html'
})
export class Reportutilizationreplacementcar extends BaseComponent implements OnInit {
  // get param from url
