...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedocumenthistorywizlist.component.html'
})

export class ReverseDocumentHistoryWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'ReverseSaleDocumentHistory';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/inquiry/subreversesalehistorylist/reversesalehistorydetail/reversesalehistorydetail' + parse.id + '/reversesaledocumenthistorylist/' + parse.id + '/reversedocumenthistorylist', parse.id]);
