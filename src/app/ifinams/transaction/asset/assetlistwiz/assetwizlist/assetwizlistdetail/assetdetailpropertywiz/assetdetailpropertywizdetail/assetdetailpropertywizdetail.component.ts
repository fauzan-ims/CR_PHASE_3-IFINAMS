...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetailpropertywizdetail.component.html'
})

export class AssetDetailPropertywizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailpropertydetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
