...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './inquirydetailassetpropertywizlist.component.html'
})

export class inquiryAssetPropertywizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
