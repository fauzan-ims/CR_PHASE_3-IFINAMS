...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfacedocumentwizlist.component.html'
})

export class AssetInterfaceDocumentlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'EfamInterfaceAssetDocument';
    ...
    private RoleAccessCode = 'R00011510000000A';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail/' + parse.id + '/assetinterfacedocumentlist', parse.id]);
