...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfaceotherwizdetail.component.html'
})

export class AssetInterfaceOtherwizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIController: String = 'EfamInterfaceAssetOther';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail/' + this.param + '/assetinterfaceotherdetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
