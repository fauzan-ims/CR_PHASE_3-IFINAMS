...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './deliveryresultlist.component.html'
})

export class DeliveryresultlistComponent extends BaseComponent implements OnInit {
    // variable
    public listdeliveryresult: any = [];
    ...
    private RoleAccessCode = 'R00022350000000A';
    ...
    // API Function
    private APIRouteForGetRows: String = 'GetRowsForDelivery';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listdeliveryresult = parse.data;
                    if (parse.data != null) {
                        this.listdeliveryresult.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/birojasa/deliveryresultlist/deliveryresultdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/birojasa/deliveryresultlist/deliveryresultdetail', codeEdit]);
    }
