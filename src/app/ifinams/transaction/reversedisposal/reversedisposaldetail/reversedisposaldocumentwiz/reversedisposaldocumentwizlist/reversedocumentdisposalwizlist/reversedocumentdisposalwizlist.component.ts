...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedocumentdisposalwizlist.component.html'
})

export class ReverseDocumentDisposalWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'ReverseDisposalDocument';
    private APIControllerOrder: String = 'ReverseDisposal';
