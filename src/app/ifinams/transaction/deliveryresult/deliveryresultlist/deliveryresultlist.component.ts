...
export class DeliveryresultlistComponent extends BaseComponent implements OnInit {
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subdeliveryresultlist/deliveryresultdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subdeliveryresultlist/deliveryresultdetail', codeEdit]);
    }
