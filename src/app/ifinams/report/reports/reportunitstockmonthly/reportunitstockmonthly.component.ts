...
@Component({
  selector: 'app-reportunitstockmonthly',
  templateUrl: './reportunitstockmonthly.component.html'
})
export class Reportstockmonthly extends BaseComponent implements OnInit {
  // get param from url
