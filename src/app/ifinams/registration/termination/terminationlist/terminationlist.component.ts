...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './terminationlist.component.html'
})
export class TerminationlistComponent extends BaseComponent implements OnInit {

  // get param from url
  param = this.getRouteparam.snapshot.paramMap.get('id');

  // variable
  public listterminationmain: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_termination_status': this.tampStatus,
          'p_insurance_type': this.tampType,
        })
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp)
          this.listterminationmain = parse.data;
          if (parse.data != null) {
            this.listterminationmain.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/registration/subterminationlist/terminationdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/registration/subterminationlist/terminationdetail', codeEdit]);
  }
