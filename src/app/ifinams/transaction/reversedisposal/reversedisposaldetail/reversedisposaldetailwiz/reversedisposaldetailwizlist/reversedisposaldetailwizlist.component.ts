...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedisposaldetailwizlist.component.html'
})

export class ReverseDisposalDetailwizlistComponent extends BaseComponent implements OnInit {
    ...
    private idDetailForCostCenter: any;
    public listdataDetail: any = [];


    //controller
    private APIController: String = 'ReverseDisposalDetail';
    private APIControllerHeader: String = 'ReverseDisposal';
    private APIControllerCostCenter: String = 'CostCenter';
    private APIControllerAsset: String = 'Disposal';
    ...
    private APIRouteLookupForDisposal: String = 'GetRowsForLookupReverseDetail';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                dtParameters.paramTamp.push({
                    'p_reverse_disposal_code': this.param,
                })
    ...
    btnSelectRowCostCenter(cost_center_code: String, cost_center_name: String) {
        ...
        while (i < getID.length) {
            ...
            if (getID[i] == this.idDetailForCostCenter) {
        ...
        this.dalservice.Update(this.listdataDetail, this.APIController, this.APIRouteForUpdateCostCenter)
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        $('#datatableReverseDetail').DataTable().ajax.reload();
                    } else {
        ...
        $('#datatableLookupAsset').DataTable({
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                dtParameters.paramTamp.push({
                    ...
                    'p_disposal_code': this.model.disposal_code,
                });
                // end param tambahan untuk getrows dynamic
