...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './changecategorydetail.component.html'
})

export class ChangecategorydetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private dataTampChangeCategoryData: any = [];
    ...
    //controller
    private APIController: String = 'ChangeCategory';
    ...
    private RoleAccessCode = 'R00016080000000A';
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/transaction/subchangecategorylist']);
    ...
    btnProceed() {
        ...
        this.dataTampChangeCategoryData = [{
            'p_code': this.param,
            'action': 'default'
        }];
        // param tambahan untuk getrole dynamic
        ...
        swal({
            ...
            if (result.value) {
                this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForProceed)
                    .subscribe(
                        res => {
                            this.showSpinner = false;
                            const parse = JSON.parse(res);
    ...
    btnReturn() {
        ...
        swal({
            ...
            if (result.value) {
                this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForReturn)
                    .subscribe(
                        res => {
                            this.showSpinner = false;
                            const parse = JSON.parse(res);
    ...
    btnCancel() {
        ...
        swal({
            ...
            if (result.value) {
                this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForCancel)
                    .subscribe(
                        res => {
                            this.showSpinner = false;
                            const parse = JSON.parse(res);
    ...
    //         this.showSpinner = true;
    //         if (result.value) {
    //             this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForPost)
    //                 .subscribe(
    //                     resDataChangeCategory => {
    //                         const parseDataChangeCategory = JSON.parse(resDataChangeCategory);

    //                         if (parseDataChangeCategory.result === 1) {
    //                             this.dataTamp = [{
    //                                 'p_code': "AJT"
    //                             }];
    ...
    //                         } else {
    //                             this.swalPopUpMsg(parseDataChangeCategory.data);
    //                             this.showSpinner = false;
    //                         }
    //                     },
    //                     error => {
    ...
    btnReject() {
        ...
        swal({
            ...
            if (result.value) {
                this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForReject)
                    .subscribe(
                        res => {
                            this.showSpinner = false;
                            const parse = JSON.parse(res);
    ...
    returnJournal() {
        ...
        this.dalservice.ExecSp(this.dataTampChangeCategoryData, this.APIController, this.APIRouteForReturnJournal)
            .subscribe(
                resReturn => {
    ...
    btnSelectRowFromItem(code: string, barcode: string, item_name: string, depre_category_comm_code: string, depre_category_comm_name: string, depre_category_fiscal_code: string
        , depre_category_fiscal_name: string, category_code: string, category_name: string, item_code: string, original_price: string, net_book_value_comm: string
        , net_book_value_fiscal: string, purchase_price: string, cost_center_code: string, cost_center_name: string) {
        this.model.asset_code = code;
        this.model.barcode = barcode;
        this.model.item_name = item_name;
        this.model.from_item_name = item_name;
        this.model.from_depre_category_comm_code = depre_category_comm_code;
        this.model.depre_category_comm_name = depre_category_comm_name;
        this.model.from_depre_category_fiscal_code = depre_category_fiscal_code;
        ...
        this.model.cost_center_code = cost_center_code;
        this.model.cost_center_name = cost_center_name;
        this.model.to_net_book_value_fiscal = net_book_value_fiscal;
        this.model.to_net_book_value_comm = net_book_value_comm;
    ...
    btnSelectRowToItem(code: string, description: string, fa_category_code: string, fa_category_name: string, item_group_code: string
        , depre_cat_commercial_code: string, depre_cat_commercial_name: string, depre_cat_fiscal_code: string, depre_cat_fiscal_name: string, category_name: string) {
        ...
        this.model.to_category_name = category_name;
        this.model.item_group_code = item_group_code;
        this.model.to_depre_category_fiscal_code = depre_cat_fiscal_code;
        this.model.description_fiscal = depre_cat_fiscal_name;
        this.model.to_depre_category_comm_code = depre_cat_commercial_code;
        this.model.description_commercial = depre_cat_commercial_name;
