...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdepreciationfiscalwizlist.component.html'
})

export class AssetDepreFiscalWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    param = this.getRouteparam.snapshot.paramMap.get('id');
    params = this.getRouteparam.snapshot.paramMap.get('id2');

    // variable
    public listassetdeprefiscal: any = [];
    ...
    //controller
    private APIController: String = 'AssetDepreciationScheduleFiscal';
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    for (let i = 0; i < parse.data.length; i++) {
                        this.listassetdeprefiscal = parse.data;
                    }

                    this.listassetdeprefiscal = parse.data;

                    if (parse.data != null) {
                        this.listassetdeprefiscal.numberIndex = dtParameters.start;
                    }
