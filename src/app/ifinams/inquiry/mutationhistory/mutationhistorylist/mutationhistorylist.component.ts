...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './mutationhistorylist.component.html'
})

export class MutationHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    //controller
    private APIController: String = 'MutationHistory';
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/submutationhistorylist/mutationhistorydetail', codeEdit]);
    }
