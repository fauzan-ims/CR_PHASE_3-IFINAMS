...
export class AdjustmentdetailComponent extends BaseComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.param != null) {
            ...
            this.model.date = this.model.to_date;
            this.callGetrow();
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/transaction/subadjustmentlist']);
        $('#datatable').DataTable().ajax.reload();
    }
    ...
    btnSelectRowAsset(code: string, barcode: string, item_name: string, item_code: string, location_code: string,
        ...
        net_book_value_fiscal: string, original_price: string, purchase_price: string, new_purchase_date: string, plat_no: string
    ) {
    ...
    adjustmentdetailwiz() {
        this.route.navigate(['/transaction/subadjustmentlist/adjustmentdetail/' + this.param + '/adjustmentdetaillist', this.param], { skipLocationChange: true });
    }
    adjustmentdocumentwiz() {
        this.route.navigate(['/transaction/subadjustmentlist/adjustmentdetail/' + this.param + '/adjustmentdocumentlist', this.param], { skipLocationChange: true });
    }
