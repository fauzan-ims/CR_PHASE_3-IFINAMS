...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './replacementonhandlist.component.html'
})

export class ReplacementOnHandListComponent extends BaseComponent implements OnInit {
    // variable

    public listreplacementonhand: any = [];
    ...
    private RoleAccessCode = 'R00024620000001A';
    ...
    private APIRouteForGetRows: String = 'GetRowsReplacementOnHand';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listreplacementonhand = parse.data;
                    if (parse.data != null) {
                        this.listreplacementonhand.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    selectAllTable() {
      for (let i = 0; i < this.listreplacementonhand.length; i++) {
        this.listreplacementonhand[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.listreplacementonhand.every(function (item: any) {
