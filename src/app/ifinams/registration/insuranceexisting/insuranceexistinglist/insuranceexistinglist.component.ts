...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './insuranceexistinglist.component.html'
})

export class InsuranceexistinglistComponent extends BaseComponent implements OnInit {
  // variable
  public listinsuranceexisting: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listinsuranceexisting = parse.data;
          if (parse.data != null) {
            this.listinsuranceexisting.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/registration/subinsuranceexistinglist/insuranceexistingdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/registration/subinsuranceexistinglist/insuranceexistingdetail', codeEdit]);
  }
  //#endregion button edit

  //#region InsuranceExisting Branch Lookup
  btnLookupbranch() {
