...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './mutationhistorydetail.component.html'
})

export class MutationHistoryDetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/inquiry/submutationhistorylist']);
    ...
    mutationdetailwiz() {
        this.route.navigate(['/inquiry/submutationhistorylist/mutationhistorydetail/' + this.param + '/mutationdetailhistorylist', this.param], { skipLocationChange: true });
    }
    mutationdocumentwiz() {
        this.route.navigate(['/inquiry/submutationhistorylist/mutationhistorydetail/' + this.param + '/mutationdocumenthistorylist', this.param], { skipLocationChange: true });
    }
