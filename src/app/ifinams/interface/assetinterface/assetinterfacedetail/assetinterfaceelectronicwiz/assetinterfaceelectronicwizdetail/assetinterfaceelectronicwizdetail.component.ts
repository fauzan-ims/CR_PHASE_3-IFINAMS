...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfaceelectronicwizdetail.component.html'
})

export class AssetInterfaceElectronicWizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIController: String = 'EfamInterfaceAsseElectronic';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail/' + this.param + '/assetinterfaceelectronicdetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
