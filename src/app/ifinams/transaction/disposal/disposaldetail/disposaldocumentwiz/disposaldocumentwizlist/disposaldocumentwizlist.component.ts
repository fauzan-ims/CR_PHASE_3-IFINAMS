...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposaldocumentwizlist.component.html'
})

export class DisposalDocumentlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIControllerOrder: String = 'Disposal';
