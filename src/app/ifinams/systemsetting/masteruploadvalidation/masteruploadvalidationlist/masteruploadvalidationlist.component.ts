...
export class MasterUploadValidationlistComponent extends BaseComponent implements OnInit {
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/systemsetting/submasteruploadvalidationlist/masteruploadvalidationdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/systemsetting/submasteruploadvalidationlist/masteruploadvalidationdetail', codeEdit]);
  }
