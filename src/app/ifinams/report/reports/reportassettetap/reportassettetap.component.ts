...
@Component({
  selector: 'app-reportassettetap',
  templateUrl: './reportassettetap.component.html'
})
export class ReportAssetTetap extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteLookupReport: String = 'GetRowsForLookupReportAssetTetap';
  private APIControllerSysItemGroupCode: String = 'MasterItemGroup';
  private APIRouteForGetRow: String = 'GETROW';
  private APIRouteForLookup: String = 'GetRowsForLookup';
  private APIRouteForGetPrint: String = 'PrintFileAssetTetap';
