...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './soldrequestassetwizdetail.component.html'
})

export class SoldrequestassetwizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
