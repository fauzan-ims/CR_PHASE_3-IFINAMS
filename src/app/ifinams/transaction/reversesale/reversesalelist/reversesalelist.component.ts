...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversesalelist.component.html'
})

export class ReverseSaleListComponent extends BaseComponent implements OnInit {
    // variable
    public listsale: any = [];
    public dataTamp: any = [];
    public status: any;
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subreversesale/reversesaledetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subreversesale/reversesaledetail', codeEdit]);
    }
