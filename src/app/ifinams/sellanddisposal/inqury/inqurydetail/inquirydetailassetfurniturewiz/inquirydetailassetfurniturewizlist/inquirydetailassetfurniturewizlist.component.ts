...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './inquirydetailassetfurniturewizlist.component.html'
})

export class InquiryAssetFurniturewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
