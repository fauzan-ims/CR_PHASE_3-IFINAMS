...
export class ClaimlistComponent extends BaseComponent implements OnInit {
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_claim_status': this.tampStatus,
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listclaimmain = parse.data;
          if (parse.data != null) {
            this.listclaimmain.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/registration/subclaimlist/claimdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/registration/subclaimlist/claimdetail', codeEdit]);
  }
