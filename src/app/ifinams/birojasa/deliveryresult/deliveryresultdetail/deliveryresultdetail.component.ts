...
export class DeliveryresultdetailComponent extends BaseComponent implements OnInit {
        ...
        this.dalservice.Getrow(this.dataTamp, this.APIController, this.APIRouteForGetRow)
            .subscribe(
                res => {
                    ...
                    if (parsedata.register_status !== 'PENDING') {
                        this.isButton = true;
                    } else {
                        this.isButton = false;
                    }
    ...
    btnBack() {
        ...
        this.route.navigate(['/birojasa/deliveryresultlist']);
    }
    ...
    //     const usersJson: any[] = Array.of(this.deliveryresultData);
    //     // call web service
    //     this.dalservice.Update(usersJson, this.APIController, this.APIRouteForGetPost)
    //         .subscribe(
    //             res => {
    //                 this.showSpinner = false;
    //                 const parse = JSON.parse(res);
