...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposaldetailhistorydetailwizlist.component.html'
})

export class DisposalDetailHistoryDetailwizlistComponent extends BaseComponent implements OnInit {
    ...
    //controller
    private APIController: String = 'DisposalDetailHistory';
    private APIControllerHeader: String = 'DisposalHistory';
    ...
    private RoleAccessCode = 'R00022010000000A';
