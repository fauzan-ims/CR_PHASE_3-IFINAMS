...
@Component({
  selector: 'app-reportdeliveryvehiclebast',
  templateUrl: './reportdeliveryvehiclebast.component.html'
})
export class Reportdeliveryvehiclebast extends BaseComponent implements OnInit {
  // get param from url
