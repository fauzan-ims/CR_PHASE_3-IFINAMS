...
export class RegionlistComponent extends BaseComponent implements OnInit {
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listregion = parse.data;
          this.listregion.numberIndex = dtParameters.start;
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/systemsetting/subregionlist/regiondetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/systemsetting/subregionlist/regiondetail', codeEdit]);
  }
