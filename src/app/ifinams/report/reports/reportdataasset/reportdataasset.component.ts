...
@Component({
    selector: 'app-reportdataasset',
    templateUrl: './reportdataasset.component.html'
})
export class Reportdataasset extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIRouteForLookupMarketing: String = 'GetRowsForLookupMarketing';
