...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './masterdashboarduserdetail.component.html'
})
...
export class MasterdashboarduserdetailComponent extends BaseComponent implements OnInit {
    ...
    private APIControllerSysEmployee = 'SysCompanyUserMain';
            ...
            this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
                .subscribe(
                    res => {
                        ...
                        if (parse.result === 1) {
                            this.showNotification('bottom', 'right', 'success');
                            this.route.navigate(['/setting/submasterdashboarduserlist/masterdashboarduserdetail', parse.id]);
                            this.showSpinner = false;
                        } else {
                            this.swalPopUpMsg(parse.data);
                        }
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/systemsetting/masterdashboarduserlist']);
    ...
    btnLookupModalEmployee() {
        ...
        $('#datatableEmployee').DataTable({
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                // end param tambahan untuk getrows dynamic
                this.dalservice.Getrows(dtParameters, this.APIControllerSysEmployee, this.APIRouteForLookup).subscribe(resp => {
                    const parse = JSON.parse(resp);
