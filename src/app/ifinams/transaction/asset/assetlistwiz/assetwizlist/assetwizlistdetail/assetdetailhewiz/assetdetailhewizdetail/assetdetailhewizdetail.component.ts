...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetailhewizdetail.component.html'
})

export class AssetDetailHEwizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'AssetHe';
    ...
    //#region  form submit
    onFormSubmit(AssetHEForm: NgForm, isValid: boolean) {
        ...
        this.AssetMachineData = this.JSToNumberFloats(AssetHEForm);
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailhedetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
