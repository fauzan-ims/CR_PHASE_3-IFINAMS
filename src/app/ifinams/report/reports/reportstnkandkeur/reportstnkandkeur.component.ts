...
@Component({
  selector: 'app-reportstnkandkeur',
  templateUrl: './reportstnkandkeur.component.html'
})
export class Reportstnkandkeur extends BaseComponent implements OnInit {
  // get param from url
  ...
  onFormSubmit(rptForm: NgForm, isValid: boolean, print_option: any) {
    ...
    this.reportData.p_type_option = this.model.type_option;
