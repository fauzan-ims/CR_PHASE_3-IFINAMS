...
@Component({
  selector: 'app-reportdefferedinsuranceregistration',
  templateUrl: './reportdefferedinsuranceregistration.component.html'
})
export class ReportdefferedinsuranceregistrationComponent extends BaseComponent implements OnInit {
  // get param from url
