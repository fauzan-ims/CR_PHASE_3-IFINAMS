...
@Component({
  selector: 'app-reportassetdepreciation',
  templateUrl: './reportassetdepreciation.component.html'
})
export class ReportassetdepreciationComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForLookupAsset: String = 'GetRowsForLookupAssetWithoutAll';
  ...
  onFormSubmit(rptForm: NgForm, isValid: boolean, print_option: any) {
    ...
    this.reportData.p_options = this.model.options;
  ...
  Print() {
    ...
    const dataParam = {
        TableName: 'rpt_asset_depreciation',
        SpName: 'xsp_rpt_asset_depreciation',
        reportparameters: {
