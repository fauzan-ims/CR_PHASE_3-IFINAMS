...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './sellpermitlist.component.html'
})

export class SellpermitlistComponent extends BaseComponent implements OnInit {
  // variable
  public listrepopermitprocess: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listrepopermitprocess = parse.data;

          if (parse.data != null) {
            this.listrepopermitprocess.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/sellanddisposal/subsellpermitlist/sellpermitdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/sellanddisposal/subsellpermitlist/sellpermitdetail', codeEdit]);
  }
