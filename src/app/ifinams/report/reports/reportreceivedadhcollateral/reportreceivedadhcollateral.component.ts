...
@Component({
  selector: 'app-reportreceivedadhcollateral',
  templateUrl: './reportreceivedadhcollateral.component.html'
})
export class Reportreceivedadhcollateral extends BaseComponent implements OnInit {
  // get param from url
  ...
  private RoleAccessCode = 'R00017500000000A';
