...
@Component({
  selector: 'app-reportdeliverycollectorder',
  templateUrl: './reportdeliverycollectorder.component.html'
})
export class Reportdeliverycollectorder extends BaseComponent implements OnInit {
  // get param from url
