...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './saledocumenthistorywizlist.component.html'
})

export class SaleDocumentHistorywizlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIControllerOrder: String = 'SaleHistory';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subsale/saledetail/' + parse.id + '/saledocumentlist', parse.id]);
