...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetailmachinewizdetail.component.html'
})

export class AssetDetailMachinewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailmachinedetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
