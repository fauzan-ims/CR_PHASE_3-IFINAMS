...
export class MasterfaqlistComponent extends BaseComponent implements OnInit {
  ...
  private RoleAccessCode = 'R00022790000001A'; // role access 
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/controlpanel/submasterfaqlist/submasterfaqdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/controlpanel/submasterfaqlist/submasterfaqdetail', codeEdit]);
  }
