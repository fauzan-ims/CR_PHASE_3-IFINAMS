...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './adjustmentdocumenthistorywizlist.component.html'
})

export class AdjustmentdocumentHistorywizlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'AdjustmentDocumentHistory';
