...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './changeitemtypehistorydetail.component.html'
})

export class ChangeItemTypeHistoryDetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/inquiry/subchangeitemtypehistorylist']);
