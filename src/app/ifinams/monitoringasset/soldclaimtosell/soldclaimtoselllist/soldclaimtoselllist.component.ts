...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './soldclaimtoselllist.component.html'
})

export class SoldClaimToSellListComponent extends BaseComponent implements OnInit {
    // variable

    public listsoldclaimtosell: any = [];
    ...
    private RoleAccessCode = 'R00024640000001A';
    ...
    private APIRouteForGetRows: String = 'GetRowsSoldClaimToSell';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listsoldclaimtosell = parse.data;
                    if (parse.data != null) {
                        this.listsoldclaimtosell.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    selectAllTable() {
      for (let i = 0; i < this.listsoldclaimtosell.length; i++) {
        this.listsoldclaimtosell[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.listsoldclaimtosell.every(function (item: any) {
