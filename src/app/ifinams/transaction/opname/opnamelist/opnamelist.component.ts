...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './opnamelist.component.html'
})

export class OpnameListComponent extends BaseComponent implements OnInit {
    // variable
    public listopname: any = [];
    public dataTamp: any = [];
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.listopname = parse.data;

                    if (parse.data != null) {
                        this.listopname.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subopname/opnamedetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subopname/opnamedetail', codeEdit]);
    }
    ...
    //#region button Print
    btnPrintBast() {
        const rptParam = [this.JSToNumberFloats({
        ...
        const dataParam = {
            TableName: "RPT_BERITA_ACARA_STOCK_OPNAME",
            SpName: "xsp_rpt_berita_acara_stock_opname",
