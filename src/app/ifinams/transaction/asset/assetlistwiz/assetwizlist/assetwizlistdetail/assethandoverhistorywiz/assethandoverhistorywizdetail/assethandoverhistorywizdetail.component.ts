...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assethandoverhistorywizdetail.component.html'
})

export class AssetHandoverhistorydetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    ngOnInit() {
        ...
        if (this.params != null) {
            ...
            this.callGetrow();
            this.assethandoverhistoryassetdocumentwiz();
            $('#tabHandoverHistoryDocument .nav-link').addClass('active');
        } else {
    ...
    btnBack() {
        ...
        $('#datatablehandoverhistory').DataTable().ajax.reload();
    }
    //#endregion button back

    //#region Handover list tabs
    assethandoverhistoryassetcheklistwiz() {
        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailhandoverhistory/' + this.param + '/assetdetailhandoverhistorydetail/' + this.param + '/' + this.params + '/assetdetailhandoverhistorychecklist/', this.param, this.params], { skipLocationChange: true });
    }
    assethandoverhistoryassetdocumentwiz() {
        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailhandoverhistory/' + this.param + '/assetdetailhandoverhistorydetail/' + this.param + '/' + this.params + '/assetdetailhandoverhistorydocument/', this.param, this.params], { skipLocationChange: true });
        // this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailhandoverhistory/' + this.param + '/assetdetailhandoverhistorydocument/', this.param, this.params], { skipLocationChange: true });
