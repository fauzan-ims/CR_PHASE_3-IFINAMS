...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './stockoncustomeractivelist.component.html'
})

export class StockOnCustomerActivelistComponent extends BaseComponent implements OnInit {
    // variable

    public liststockoncustomeractive: any = [];
    ...
    private APIRouteForGetRows: String = 'GetRowsSocActive';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.liststockoncustomeractive = parse.data;
                    if (parse.data != null) {
                        this.liststockoncustomeractive.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
    ...
    selectAllTable() {
      for (let i = 0; i < this.liststockoncustomeractive.length; i++) {
        this.liststockoncustomeractive[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.liststockoncustomeractive.every(function (item: any) {
