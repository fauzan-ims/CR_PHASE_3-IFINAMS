...
@Component({
  selector: 'app-reportjournaldepreciation',
  templateUrl: './reportjournaldepreciation.component.html'
})
export class Reportjournaldepreciation extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileReportJournalDepreciation';
    ...
    const dataParam = [this.JSToNumberFloats(
      {
        ...
        'p_journal_id': this.reportData.p_journal_id,
