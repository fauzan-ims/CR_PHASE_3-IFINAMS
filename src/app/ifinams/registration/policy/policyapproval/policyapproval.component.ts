...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './policyapproval.component.html'
})

export class PolicyApprovalComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  public listpolicymainperiod: any = [];
  public listpolicymainperiodadjusment: any = [];
  public listpolicymainloading: any = [];
  public listpolicymainhistory: any = [];
  ...
  private APIControllerInsurancePolicyAsset: String = 'InsurancePolicyAsset';
  private APIControllerCoverage: String = 'InsurancePolicyMainPeriod';
  private APIControllerAdjustment: String = 'InsurancePolicyMainPeriodAdjusment';
  private APIControllerLoading: String = 'InsurancePolicyMainLoading';
  private APIControllerHistory: String = 'InsurancePolicyMainHistory';
  ...
  dtOptionsCoverage: DataTables.Settings = {};
  dtOptionsAdjustment: DataTables.Settings = {};
  dtOptionsLoading: DataTables.Settings = {};
  ...
  ngOnInit() {
    ...
    if (this.param != null) {
      ...
      this.loadData();
      this.loadDataCoverage();
      this.loadDataAdjustment();
  ...
  loadData() {
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIControllerInsurancePolicyAsset, this.APIRouteForGetRows).subscribe(resp => {
  ...
  loadDataCoverage() {
    this.dtOptionsCoverage = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerCoverage, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp);
          this.listpolicymainperiod = parse.data;
          this.listpolicymainperiod.numberIndex = dtParameters.start;
  ...
  loadDataAdjustment() {
    this.dtOptionsAdjustment = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerAdjustment, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp);
  ...
  loadDataLoading() {
    this.dtOptionsLoading = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerLoading, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp);
          this.listpolicymainloading = parse.data;
          this.listpolicymainloading.numberIndex = dtParameters.start;
  ...
  loadDataHistory() {
    this.dtOptionsHistory = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerHistory, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp);
          this.listpolicymainhistory = parse.data;
          this.listpolicymainhistory.numberIndex = dtParameters.start;
