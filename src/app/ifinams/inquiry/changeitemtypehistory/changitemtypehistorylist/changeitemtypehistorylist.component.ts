...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './changeitemtypehistorylist.component.html'
})

export class ChangeItemTypeHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    public listchangeitemtype: any = [];
    public dataTamp: any = [];
    ...
    //controller
    private APIController: String = 'ChangeItemTypeHistory';
    ...
    private RoleAccessCode = 'R00022180000000A';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.listchangeitemtype = parse.data;

                    if (parse.data != null) {
                        this.listchangeitemtype.numberIndex = dtParameters.start;
                    }
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subchangeitemtypehistorylist/changeitemtypedetail', codeEdit]);
    }
