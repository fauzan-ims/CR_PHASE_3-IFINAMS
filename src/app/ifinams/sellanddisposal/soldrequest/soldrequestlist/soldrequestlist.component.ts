...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './soldrequestlist.component.html'
})

export class SoldRequestListComponent extends BaseComponent implements OnInit {
    // variable
    public listsale: any = [];
    public dataTamp: any = [];
    public status: any;
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/sellanddisposal/subsoldrequestlist/soldrequestdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/sellanddisposal/subsoldrequestlist/soldrequestdetail', codeEdit]);
    }
    ...
    //#region ddl Type
    SellType(event: any) {
        this.sellType = event.target.value;
        $('#datatablesoldrequest').DataTable().ajax.reload();
    }
    //#endregion ddl Type
