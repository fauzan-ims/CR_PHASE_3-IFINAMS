...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetdetailfurniturewizdetail.component.html'
})

export class AssetDetailFurniturewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/subasset/assetwizlistdetail/' + this.param + '/assetdetailfurnituredetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
