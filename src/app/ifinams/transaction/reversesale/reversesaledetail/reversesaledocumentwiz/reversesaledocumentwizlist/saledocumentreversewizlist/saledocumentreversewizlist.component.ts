...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './saledocumentreversewizlist.component.html'
})

export class SaleDocumentReverseWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'SaleDocument';
    ...
    handleFile(event) {
        ...
        this.tamps.push({
            p_module: 'IFINAMS',
            p_header: 'REVERSE_SELL_DOCUMENT',
            p_child: this.param,
            p_id: this.tampDocumentCode,
