...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './changeitemtypelist.component.html'
})

export class ChangeItemTypeListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subchangeitemtypelist/changeitemtypedetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subchangeitemtypelist/changeitemtypedetail', codeEdit]);
    }
