...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposallist.component.html'
})

export class DisposalListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    private RoleAccessCode = 'R00021650000000A';
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subdisposal/disposaldetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subdisposal/disposaldetail', codeEdit]);
    }
