...
@Component({
  selector: 'app-reportdepreciationasset',
  templateUrl: './reportdepreciationasset.component.html'
})
export class ReportDepreciationAsset extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileDepreciationAsset';
  ...
  ngOnInit() {
    ...
    this.model.net_book_value_type = 'ALL';
    this.model.threshold_type = 'ALL';
  }
    ...
    const dataParam = [this.JSToNumberFloats(
      {
        ...
        'p_net_book_value_type': this.model.net_book_value_type,
        'p_threshold_type': this.model.threshold_type
      }
    )];      
  ...
  btnLookupBranch() {
    ...
    $('#datatableLookupBranch').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.GetrowsSys(dtParameters, this.APIControllerBranch, this.APIRouteLookupArea).subscribe(resp => {
