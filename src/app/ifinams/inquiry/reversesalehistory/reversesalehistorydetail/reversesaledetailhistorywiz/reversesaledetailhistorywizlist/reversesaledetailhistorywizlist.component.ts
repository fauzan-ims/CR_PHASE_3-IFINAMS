...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversesaledetailhistorywizlist.component.html'
})

export class ReverseSaleDetailHistorywizlistComponent extends BaseComponent implements OnInit {
    ...
    public listsaledetailhistory: any = [];
    public dataTamp: any = [];
    ...
    //controller
    private APIController: String = 'ReverseSaleDetailHistory';
    private APIControllerCostCenter: String = 'CostCenter';
    private APIControllerHeader: String = 'ReverseSaleHistory';
    private APIControllerAsset: String = 'Sale';
    ...
    private APIRouteLookupForSale: String = 'GetRowsForLookupDetail';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                dtParameters.paramTamp.push({
                    'p_reverse_sale_code': this.param,
                })
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/inquiry/subsalehistorylist/salehistorydetail/' + this.param + '/saledetaillist/' + this.param + '/saledetaildetail', this.param], { skipLocationChange: true });
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subsalehistorylist/saledetail/' + this.param + '/saledetaillist/' + this.param + '/saledetaildetail', this.param, codeEdit], { skipLocationChange: true });
    }
    ...
    btnSelectAllLookup() {
        ...
        for (let i = 0; i < this.lookupAsset.length; i++) {
            if (this.lookupAsset[i].selectedLookup) {
                this.checkedLookup.push({
                    code: this.lookupAsset[i].code,
                    assetCode: this.lookupAsset[i].asset_code,
                    saleAmount: this.lookupAsset[i].sale_amount,
                });
            }
        }
        ...
        for (let J = 0; J < this.checkedLookup.length; J++) {
            ...
            this.dataTamp = [{
                ...
                'p_sale_value': this.checkedLookup[J].saleAmount,
            }];
        ...
        $('#datatableLookupAsset').DataTable({
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                dtParameters.paramTamp.push({
                    ...
                    'p_sale_code': this.model.sale_code,
                });
                // end param tambahan untuk getrows dynamic
    ...
    btnSelectRowCostCenter(code: String) {
