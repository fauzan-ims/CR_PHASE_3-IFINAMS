...
export class OrdertopublicservicelistComponent extends BaseComponent implements OnInit {
    ...
    loadData() {
        this.dtOptions = {
            ...
            columnDefs: [{ orderable: false, width: '5%', targets: [8] }], // for disabled coloumn
            language: {
                search: '_INPUT_',
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subordertobirojasalist/ordertopublicservicedetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subordertobirojasalist/ordertopublicservicedetail', codeEdit]);
    }
