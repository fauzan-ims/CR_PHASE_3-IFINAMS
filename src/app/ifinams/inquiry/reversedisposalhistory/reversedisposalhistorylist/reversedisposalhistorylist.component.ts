...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedisposalhistorylist.component.html'
})

export class ReverseDisposalHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subreversedisposalhistorylist/reversedisposalhistorydetail', codeEdit]);
    }
