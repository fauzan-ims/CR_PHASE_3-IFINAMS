...
@Component({
  selector: 'app-reportbastunitreport',
  templateUrl: './reportbastunitreport.component.html'
})
export class Reportbastunitreport extends BaseComponent implements OnInit {
  // get param from url
