...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './stockonhandreservedlist.component.html'
})

export class StockOnHandReservedListComponent extends BaseComponent implements OnInit {
    // variable

    public liststockonhandreserved: any = [];
    ...
    private RoleAccessCode = 'R00024590000001A';
    ...
    private APIRouteForGetRows: String = 'GetRowsStockOnHandReserved';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.liststockonhandreserved = parse.data;
                    if (parse.data != null) {
                        this.liststockonhandreserved.numberIndex = dtParameters.start;
                    }
                    callback({
                        draw: parse.draw,
            ...
            columnDefs: [{ orderable: false, width: '5%', targets: [0, 13] }], // for disabled coloumn
            language: {
                search: '_INPUT_',
    ...
    selectAllTable() {
      for (let i = 0; i < this.liststockonhandreserved.length; i++) {
        this.liststockonhandreserved[i].selectedTable = this.selectedAllTable;
      }
    }
  
    checkIfAllTableSelected() {
      this.selectedAllTable = this.liststockonhandreserved.every(function (item: any) {
