...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './inquirydetailassetelectronicwizlist.component.html'
})

export class InquiryAssetElectronicwizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
