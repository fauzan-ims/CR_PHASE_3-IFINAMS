...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './spafclaimlist.component.html'
})

export class SpafClaimListComponent extends BaseComponent implements OnInit {
    // variable
    public listspafclaim: any = [];
    public dataTamp: any = [];
    public status: any;
    ...
    private RoleAccessCode = 'R00024190000001A';
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.listspafclaim = parse.data;

                    if (parse.data != null) {
                        this.listspafclaim.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subspafclaimlist/spafclaimdetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subspafclaimlist/spafclaimdetail', codeEdit]);
    }
