...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinsurancedetail.component.html'
})

export class AssetInsuranceDetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIRouteForGetRow: String = 'GetRowAssetInsurance';
    private APIRouteForInsert: String = 'INSERT';
    private APIRouteForUpdate: String = 'UPDATE';

    private RoleAccessCode = 'R00021450000000A'; // role access 
