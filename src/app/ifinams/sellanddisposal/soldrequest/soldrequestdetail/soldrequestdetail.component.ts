...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './soldrequestdetail.component.html'
})

export class SoldRequestdetailComponent extends BaseComponent implements OnInit {
    // get param from url
        ...
        this.dalservice.Getrow(this.dataTamp, this.APIController, this.APIRouteForGetRow)
            .subscribe(
                res => {
                    ...
                    if (this.model.sell_type === 'MOCIL') {
                        this.isMocil = false
                    } else {
                        this.isMocil = true
                    }

                    if (this.model.sell_type === 'COP') {
                        this.isCOP = true
                    } else {
                        this.isCOP = false
                    }
    ...
    btnPrintPJB() {
        ...
        const dataParam = {
            TableName: 'rpt_cetakan_pjb',
            SpName: 'xsp_rpt_cetakan_pjb',
            reportparameters: {
                p_user_id: this.userId,
                p_code: this.param,
                p_sell_code: this.model.code,
                p_print_option: 'PDF'
            }
        };
    ...
    saledetailattachwiz() {
        this.route.navigate(['/sellanddisposal/subsoldrequestlist/soldrequestdetail/' + this.param + '/soldrequestattachmentlist', this.param], { skipLocationChange: true });
    }
