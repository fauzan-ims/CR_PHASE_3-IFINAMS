...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './mastercategoryfiscaldetail.component.html'
})

export class MastercategoryfiscaldetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    public lookupdepreaccount: any = [];
    public lookupaccumdepreaccount: any = [];
    public lookupgainlossaccount: any = [];
    public setStyle: any = [];
            ...
            this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
                .subscribe(
                    res => {
                        ...
                        if (parse.result === 1) {
                            this.showNotification('bottom', 'right', 'success');
                            this.route.navigate(['/systemsetting/submasterdeprecategoryfiscal/mastercategoryfiscal', parse.code]);
                        } else {
                            this.swalPopUpMsg(parse.data);
                        }
                    },
    ...
    btnBack() {
        ...
        this.route.navigate(['/systemsetting/submasterdeprecategoryfiscal']);
    }
