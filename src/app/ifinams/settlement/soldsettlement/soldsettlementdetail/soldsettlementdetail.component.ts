...
export class SoldSettlementdetailComponent extends BaseComponent implements OnInit {
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/settlement/subsoldsettlement']);
    ...
    saledetailfeewiz() {
        this.route.navigate(['/settlement/subsoldsettlement/soldsettlementdetail/' + this.param + '/soldsettlement', this.param], { skipLocationChange: true });
    }
