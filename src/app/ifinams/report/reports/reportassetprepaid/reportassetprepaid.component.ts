...
@Component({
  selector: 'app-reportassetprepaid',
  templateUrl: './reportassetprepaid.component.html'
})
export class ReportassetprepaidComponent extends BaseComponent implements OnInit {
  // get param from url
