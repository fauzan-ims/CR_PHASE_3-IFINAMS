...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedisposallist.component.html'
})

export class ReverseDisposalListComponent extends BaseComponent implements OnInit {
    // variable
    public listreversedisposal: any = [];
    public dataTamp: any = [];
    public status: any;
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.listreversedisposal = parse.data;

                    if (parse.data != null) {
                        this.listreversedisposal.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subreversedisposal/reversedisposaldetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subreversedisposal/reversedisposaldetail', codeEdit]);
    }
