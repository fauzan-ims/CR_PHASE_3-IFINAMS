...
@Component({
  selector: 'app-reportkeuntungankerugian',
  templateUrl: './reportkeuntungankerugian.component.html'
})
export class Reportkeuntungankerugian extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileKeuntunganKerugianPenjualanAsset';
