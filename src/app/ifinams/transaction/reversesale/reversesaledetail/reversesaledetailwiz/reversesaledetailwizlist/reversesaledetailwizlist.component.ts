...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversesaledetailwizlist.component.html'
})

export class ReverseSaleDetailwizlistComponent extends BaseComponent implements OnInit {
    ...
    //controller
    private APIController: String = 'ReverseSaleDetail';
    private APIControllerCostCenter: String = 'CostCenter';
    private APIControllerHeader: String = 'ReverseSale';
