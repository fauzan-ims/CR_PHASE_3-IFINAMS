...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './changecategorylist.component.html'
})

export class ChangeCategoryListComponent extends BaseComponent implements OnInit {
    // variable
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/transaction/subchangecategorylist/changecategorydetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/transaction/subchangecategorylist/changecategorydetail', codeEdit]);
    }
