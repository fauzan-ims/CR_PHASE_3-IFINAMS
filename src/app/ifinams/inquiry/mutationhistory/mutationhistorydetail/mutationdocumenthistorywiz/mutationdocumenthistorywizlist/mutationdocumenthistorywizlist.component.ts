...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './mutationdocumenthistorywizlist.component.html'
})

export class MutationDocumentHistorywizlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'MutationDocumentHistory';
    private APIControllerOrder: String = 'MutationHistory';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/transaction/submutation/mutationdetail/' + parse.id + '/mutationdocumentlist', parse.id]);
