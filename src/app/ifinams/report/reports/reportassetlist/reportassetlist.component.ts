...
@Component({
  selector: 'app-reportassetlist',
  templateUrl: './reportassetlist.component.html'
})
export class ReportAssetList extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileAssetList';
  private APIControllerSysRegionCode: String = 'SysRegion';
  ...
  ngOnInit() {
    ...
    this.model.last_so_condition = 'ALL';
    ...
    const dataParam = [this.JSToNumberFloats(
      {
        ...
        'p_last_so_condition': this.model.last_so_condition,
  ...
  btnLookupRegionCode() {
    ...
    $('#datatableLookupRegionCode').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.GetrowSys(dtParameters, this.APIControllerSysRegionCode, this.APIRouteForLookup).subscribe(resp => {
  ...
  btnLookupBranch() {
    ...
    $('#datatableLookupBranch').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.GetrowSys(dtParameters, this.APIControllerBranch, this.APIRouteLookupReport).subscribe(resp => {
          const parse = JSON.parse(resp);
