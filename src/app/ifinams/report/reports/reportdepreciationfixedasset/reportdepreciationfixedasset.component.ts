...
@Component({
  selector: 'app-reportdepreciationfixedasset',
  templateUrl: './reportdepreciationfixedasset.component.html'
})
export class ReportdepreciationfixedassetComponent extends BaseComponent implements OnInit {
  // get param from url
