...
export class MasterUnitlistComponent extends BaseComponent implements OnInit {
    ...
    private APIController: String = 'InterfaceMasterUnit';
    private APIRouteForSync: String = 'ExecSpForSync';
    private APIRouteForGetRows: String = 'GetRows';
    private RoleAccessCode = 'R00016460000000A';
    ...
    //#endunit load all data

    //#unit button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/interface/submasterunit/masterunitdetail', codeEdit]);
    }
    //#endunit button edit
