...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfacevehicledetailwiz.component.html'
})

export class AssetInterfaceVehicleDetailWizComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIController: String = 'EfamInterfaceAssetVehicle';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail/' + this.param + '/assetinterfacevehicledetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
