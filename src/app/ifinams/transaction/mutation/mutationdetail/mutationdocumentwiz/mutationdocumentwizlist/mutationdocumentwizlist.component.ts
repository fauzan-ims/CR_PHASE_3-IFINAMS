...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './mutationdocumentwizlist.component.html'
})

export class MutationDocumentwizlistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'MutationDocument';
    private APIControllerOrder: String = 'Mutation';
