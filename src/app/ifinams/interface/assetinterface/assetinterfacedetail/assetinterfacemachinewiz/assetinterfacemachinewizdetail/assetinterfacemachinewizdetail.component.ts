...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assetinterfacemachinewizdetail.component.html'
})

export class AssetInterfaceMachinewizdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIController: String = 'EfamInterfaceAssetMachine';
            ...
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        ...
                        this.route.navigate(['/interface/subassetinterface/assetinterfacedetail/' + this.param + '/assetinterfacemachinedetail', this.param, parse.id]);
                        this.callGetrow()
                    } else {
