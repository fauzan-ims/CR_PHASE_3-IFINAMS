...
export class JournaldetailComponent extends BaseComponent implements OnInit {
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'p_gl_link_transaction_code': this.param,
          'p_company_code': this.company_code
        });
        
        // end param tambahan untuk getrows dynamic
        // tslint:disable-next-line:max-line-length
        this.dalservice.Getrows(dtParameters, this.APIControllerJournalDetail, this.APIRouteForGetRows).subscribe(resp => {
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/interface/journallist']);
