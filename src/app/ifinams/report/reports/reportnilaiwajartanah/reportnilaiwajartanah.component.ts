...
@Component({
  selector: 'app-reportnilaiwajartanah',
  templateUrl: './reportnilaiwajartanah.component.html'
})
export class Reportnilaiwajartanah extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForGetPrint: String = 'PrintFileReportNilaiWajarTanah';
