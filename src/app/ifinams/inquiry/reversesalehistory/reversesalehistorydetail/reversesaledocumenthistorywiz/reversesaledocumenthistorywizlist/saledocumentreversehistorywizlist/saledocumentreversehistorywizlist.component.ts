...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './saledocumentreversehistorywizlist.component.html'
})

export class SaleDocumentReverseHistoryWizListComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //controller
    private APIController: String = 'SaleDocumentHistory';
        ...
        this.dalservice.Insert(this.dataRoleTamp, this.APIController, this.APIRouteForInsert)
            .subscribe(
                res => {
                    ...
                    if (parse.result === 1) {
                        this.route.navigate(['/inquiry/subdisposalhistorylist/disposalhistorydetail/' + parse.id + '/disposaldocumenthistorylist', parse.id]);
