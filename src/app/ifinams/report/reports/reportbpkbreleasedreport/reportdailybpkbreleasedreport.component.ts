...
@Component({
  selector: 'app-reportdailybpkbreleasedreport',
  templateUrl: './reportdailybpkbreleasedreport.component.html'
})
export class Reportdailybpkbreleasedreport extends BaseComponent implements OnInit {
  // get param from url
