...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './adjustmentdetailhistorydetailwizlist.component.html'
})

export class AdjustmentdetailhistorydetailwizlistComponent extends BaseComponent implements OnInit {
    ...
    //controller
    private APIController: String = 'AdjustmentDetailHistory';
    private APIControllerHeader: String = 'AdjustmentHistory';
