...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './assethandoverhistoryassetchecklistwizlist.component.html'
})

export class AssetHandoverHistoryAssetchecklistwizlistComponent extends BaseComponent implements OnInit {
    ...
    btnLookupCostCenter(id: any) {
        ...
        $('#datatableLookupCostCenter').DataTable({
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                // end param tambahan untuk getrows dynamic
                this.dalservice.GetrowsSys(dtParameters, this.APIControllerCostCenter, this.APIRouteLookup).subscribe(resp => {
                    const parse = JSON.parse(resp);
