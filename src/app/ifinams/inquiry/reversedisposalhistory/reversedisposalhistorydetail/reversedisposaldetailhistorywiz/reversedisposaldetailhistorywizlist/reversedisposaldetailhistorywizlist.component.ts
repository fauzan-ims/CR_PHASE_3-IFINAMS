...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversedisposaldetailhistorywizlist.component.html'
})

export class ReverseDisposalDetailHistorywizlistComponent extends BaseComponent implements OnInit {
    ...
    //controller
    private APIController: String = 'ReverseDisposalDetailHistory';
    private APIControllerHeader: String = 'ReverseDisposalHistory';
