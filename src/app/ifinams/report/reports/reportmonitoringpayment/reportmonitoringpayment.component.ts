...
@Component({
  selector: 'app-reportmonitoringpayment',
  templateUrl: './reportmonitoringpayment.component.html'
})
export class Reportmonitoringpayment extends BaseComponent implements OnInit {
  // get param from url
