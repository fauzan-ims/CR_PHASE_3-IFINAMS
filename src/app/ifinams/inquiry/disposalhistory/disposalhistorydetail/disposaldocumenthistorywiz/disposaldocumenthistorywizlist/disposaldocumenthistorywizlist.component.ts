...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './disposaldocumenthistorywizlist.component.html'
})

export class DisposalDocumentHistorylistComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIControllerOrder: String = 'DisposalHistory';
