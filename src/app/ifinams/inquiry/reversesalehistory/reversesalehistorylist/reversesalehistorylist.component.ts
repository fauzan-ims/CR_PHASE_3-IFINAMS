...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './reversesalehistorylist.component.html'
})

export class ReverseSaleHistoryListComponent extends BaseComponent implements OnInit {
    // variable
    public listsalehistory: any = [];
    public dataTamp: any = [];
    public status: any;
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    // end checkall
                    this.listsalehistory = parse.data;

                    if (parse.data != null) {
                        this.listsalehistory.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/inquiry/subreversesalehistorylist/reversesalehistorydetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/inquiry/subreversesalehistorylist/reversesalehistorydetail', codeEdit]);
    }
