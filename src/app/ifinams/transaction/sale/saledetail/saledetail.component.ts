...
export class SaledetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //#region form submit
    onFormSubmit(SaleForm: NgForm, isValid: boolean) {
        ...
        this.saleData = this.JSToNumberFloats(SaleForm);
            ...
            this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
                .subscribe(
                    res => {
                        ...
                        if (parse.result === 1) {
                            this.showNotification('bottom', 'right', 'success');
                            this.route.navigate(['/transaction/subsale/saledetail', parse.code]);
                            this.showSpinner = false;
                        } else {
                            this.swalPopUpMsg(parse.data);
                            this.showSpinner = false;
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/transaction/subsale']);
    ...
    saledetailwiz() {
        this.route.navigate(['/transaction/subsale/saledetail/' + this.param + '/saledetaillist', this.param], { skipLocationChange: true });
    }
    salebiddingwiz() {
        this.route.navigate(['/transaction/subsale/saledetail/' + this.param + '/salebiddinglist', this.param], { skipLocationChange: true });
    }
    saledocumentwiz() {
        this.route.navigate(['/transaction/subsale/saledetail/' + this.param + '/saledocumentlist', this.param], { skipLocationChange: true });
    }
